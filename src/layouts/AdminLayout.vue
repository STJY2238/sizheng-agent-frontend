  ...
  <div class="layout">
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div>
          <div class="platform-name">智教AI教学平台</div>
          <div class="platform-sub">让教学更智能</div>
        </div>
        <el-tag type="info">全校思政课程</el-tag>
        <span class="meta-text">2025-2026-2</span>
...
<script setup>
import { adminInfo as info, adminReminders as reminders } from '../mock/data.js'
</script>
