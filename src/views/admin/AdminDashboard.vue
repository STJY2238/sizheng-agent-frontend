        ...
        <el-card shadow="never" class="section-card">
          ...
          <div class="stat-row">
            <div class="stat-card">
              ...
              <div class="stat-num" style="color: #F56C6C">18</div>
              <div class="muted small">内容治理优先</div>
            </div>
            <div class="stat-card">
              <div class="muted">告警</div>
              <div class="stat-num" style="color: #E6A23C">3</div>
              <div class="muted small">建议今天处理</div>
            </div>
          </div>
        </el-card>
      </el-col>
...
const entries = [
  { title: '账号与教学组织', desc: '15-18 / 31-34 用户、课程、组织', tag: '管理' },
  { title: '知识与内容治理', desc: '19-22 知识来源与 AI 审核', tag: '审核' }
]
</script>
